        ...
        if (args.length >= 2) {
            ...
            if (tag != null) {
                return switch (args[0].toLowerCase()) {
                    ...
                    case "get-formatted" -> this.manager.getDisplayTag(tag, player, FORMATTED_PLACEHOLDER.get());
...
//        }
        ...
        if (tag == null) return Setting.FORMATTED_PLACEHOLDER.get(); // Return the formatted placeholder if the tag is null
        ...
        return switch (param) {
            ...
            case "tag_description" -> TagsUtils.formatList(tag.getDescription(), "\n");
