...
//        }
        ...
        if (item == null) {
            EternalTags.get().getLogger().warning("Item [" + this.itemPath + "] in the [" + this.config.getName() + "] menu is invalid.");
            return;
        }
    ...
    private void addActions() {
        ...
        for (String key : customActions.getKeys(false)) {
            ...
            if (clickType == null) {
                EternalTags.get().getLogger().warning("Invalid click type [" + key + "] in the " + this.itemPath + ".commands section of the [" + this.config.getName() + "] menu.");
                continue;
            }
